...
if (isset( $_POST['edit'] )) {
  ...
  $clone = mysql_query("INSERT INTO data values ( '', '$bank', '$fdr', '$amt', '$from', '$to', '$roi', '$name', '$maturity', '$int_frequent', '$amt_of_interest' )");
}
}
...
<?php if($clone) { ?>
  <div class="alert alert-success alert-dismissable fixed-alert">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Copied!</strong> Data has been Cloned.
  </div>
<?php } ?>
          ...
          ?>
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a href="#editDialog" data-type="edit" data-id="<?php echo $sel_det['id'] ?>" class="open-EditDialog btn icon" data-toggle="modal"><i class="fa fa-pencil cursor" title="Edit"></i></a>&nbsp;
                     <a href="#editDialog" data-type="copy" data-id="<?php echo $sel_det['id'] ?>" class="open-EditDialog btn icon" data-toggle="modal"><i class="fa fa-clone cursor" title="Copy" aria-hidden="true"></a></i>&nbsp;
...
$(document).on("click", ".open-EditDialog", function () {
     ...
     var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "gethint.php?id=" + id+"&type="+type, true);
        xmlhttp.send();
});
